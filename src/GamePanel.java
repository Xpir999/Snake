...
public class GamePanel extends JPanel implements ActionListener{
    ...
    public void draw(Graphics g){
        ...
        if(running){
            ...
            */
            ...
            //Places the apple on the screen
    ...
    public void gameOver(Graphics g){
        ...
        //Game Over text
            ...
            if(!gameOver){
                showRestartScreen();
                gameOver = true; // Set the flag to true after showing the restart screen
            }
    ...
    public void showRestartScreen() {
        ...
        if (choice == JOptionPane.YES_OPTION) {
            ...
            // User does not want to play again, exit program
            System.exit(0);
        }
    }
    ...
    private void gameOverLogic() {
        ...
        public void actionPerformed(ActionEvent e) {
            if (running) {
                ...
                gameOverLogic(); // Call the method to handle game over logic
            }
            repaint();
        }
